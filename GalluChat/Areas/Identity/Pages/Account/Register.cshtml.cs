...
namespace GalluChat.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public MemoryStream DefaultFormatPic { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile ? profilePicture, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //Default format of image in form
                    //We read the uploaded file into a MemoryStream.
                    using var memoryStream = new MemoryStream();
                    await profilePicture.CopyToAsync(memoryStream);
                    //Convert it into a byte array and assign it to the ProfilePicture
